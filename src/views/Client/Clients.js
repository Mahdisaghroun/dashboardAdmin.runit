...
export default function Clients() {
      ...
      const [modalRech, setModalRech] = useState(false)
      ...
      return (
            <div>
                  ...
                  >
                        ...
                        <CModalBody>
                              Vous êtes sûr de supprimer ce client ?
        </CModalBody>
                        <CModalFooter>
                  ...
                  <CModal
                        ...
                        color="primary"
                  >
                        <CModalHeader closeButton>Recharger Solde</CModalHeader>
                        <CModalBody>
                              <CRow>
                                    <CCol md="12">
                                          <CLabel htmlFor="nf-name">Veuillez Choisissez un Pack !</CLabel>
                                    </CCol>
                              </CRow>
                              <CRow>
                                    ...
                                    <CCol md="4">
                                          <select class="form-select" aria-label="Default select example">
                                                <option selected>Aucun Pack Selectionné</option>
                                                <option value="1">Pack 1000 jetons 1DT</option>
                                                <option value="2">Pack 1000 jetons 1DT</option>
                                                <option value="3">Pack 1000 jetons 1DT</option>
                                          </select>
                                    </CCol>
                              </CRow>
                              <CRow>
                                    ...
                                    >
                                          <CLabel htmlFor="nf-email">Nombre de jetons </CLabel>
                                          <CInput
                                                type="number"

                                                placeholder="0 jetons"
                                                style={{
                                                      width: 100
                                                }}
                                          />
                        ...
                        <CModalFooter>
                              <CButton color="primary">Recharger</CButton>{' '}
                              <CButton
                                    color="secondary"
                                    onClick={
                                          () => {
